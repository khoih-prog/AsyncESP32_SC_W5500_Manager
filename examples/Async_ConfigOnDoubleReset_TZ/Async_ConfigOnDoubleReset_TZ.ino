...
void setup()
{
  ...
  AsyncESP32_SC_W5500_Manager AsyncESP32_SC_W5500_manager(&webServer, NULL, "AsyncConfigOnDoubleReset");
#else
  AsyncDNSServer dnsServer;

  AsyncESP32_SC_W5500_Manager AsyncESP32_SC_W5500_manager(&webServer, &dnsServer, "AsyncConfigOnDoubleReset");
#endif
