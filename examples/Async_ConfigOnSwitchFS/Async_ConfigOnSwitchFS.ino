...
void setup()
{
  ...
  AsyncESP32_SC_W5500_Manager AsyncESP32_SC_W5500_manager(&webServer, NULL, "ConfigOnSwitchFS");
#else
...
void loop()
{
  ...
  if ((digitalRead(TRIGGER_PIN) == LOW) || (digitalRead(TRIGGER_PIN2) == LOW))
  {
    ...
    ESPAsync_EMParameter p_thingspeakApiKey(ThingSpeakAPI_Label, "Thingspeak API Key", thingspeakApiKey, 17);
